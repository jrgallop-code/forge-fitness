...
import { initializeRoutineImporter } from "../workouts/routine-importer.js?v=equal-launch-cards-1";
...
import { renderCaloriesHub, initializeFoodLog } from "../nutrition/food-log.js?v=meal-photos-macro-detail-1";
