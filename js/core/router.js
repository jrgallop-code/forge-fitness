...
import { initializeWeightCarbsChart } from "../progress/weight-carbs-chart.js?v=fatsecret-progress-calories-1";
...
import { renderCaloriesHub, initializeFoodLog } from "../nutrition/food-log.js?v=minimal-food-attribution-1";
