...
import { renderProgress } from "../progress/progress-ui.js?v=exercise-session-volume-1";
...
import { initializeExerciseProgressV2 } from "../progress/exercise-progress-v2.js?v=session-volume-1";
