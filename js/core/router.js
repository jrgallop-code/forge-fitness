...
import { initializeDashboardNutritionTargets } from "../dashboard/nutrition-target-card.js?v=subtle-macro-bars-1";
...
import { renderCaloriesHub, initializeFoodLog } from "../nutrition/food-log.js?v=subtle-macro-bars-1";
