...
import { initializeDashboardNutritionTargets } from "../dashboard/nutrition-target-card.js?v=calorie-colors-1";
...
import { renderCaloriesHub, initializeFoodLog } from "../nutrition/food-log.js?v=food-history-priority-1";
