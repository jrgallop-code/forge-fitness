...
import { renderProgress } from "../progress/progress-ui.js?v=native-photo-picker-1-photo-carousel-1-photo-gallery-detail-1";
import { initializeWeightTracker } from "../progress/weight-tracker.js?v=weight-history-trend-2";
import { initializePhotoJournal } from "../progress/photo-journal.js?v=native-photo-picker-1-photo-carousel-1-photo-gallery-detail-1";
...
import { initializeExerciseProgressV2 } from "../progress/exercise-progress-v2.js?v=equipment-labels-1";
    ...
    try {
        switch (page) {
            ...
            case "workout":
                ...
                bindManualBuildLauncher(content);
                safeInitialize("Workout schedule", () => initializeWorkoutSchedule(content));
