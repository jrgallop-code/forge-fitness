...
import { initializeSmartBuild } from "../workouts/smart-build.js?v=coach-build-personalized-1";
...
import { renderProgress } from "../progress/progress-ui.js?v=independent-tdee-staged-target-1";
...
import { initializeCalorieStats } from "../nutrition/calorie-stats.js?v=independent-tdee-staged-target-1";
...
import { renderEnergyProfile, initializeEnergyProfile } from "../nutrition/energy-profile.js?v=granular-units-1";
import { renderCaloriesHub, initializeFoodLog } from "../nutrition/food-log.js?v=voice-food-1";
...
import { renderMore, initializeMore } from "../more/more-ui-v2.js?v=pulse-theme-1";
