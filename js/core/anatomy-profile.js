...
export function getAnatomyConfig(side="front"){
  ...
  if(sex === "female") return {sex,side:back?"back":"front",asset:`assets/recovery/female-${back?"back":"front"}-view.svg?v=female-anatomy-2`,regions:back?FEMALE_BACK:FEMALE_FRONT,viewBox:"0 0 960 1920",imageX:0};
