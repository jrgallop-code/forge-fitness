...
export const CONTEXTUAL_TUTORIALS = [
    ...
    },
    {
        ...
        steps: [
            ...
            { eyebrow: "SMOOTHING", title: "Recent data matters more", body: "Level Up applies an exponentially weighted smoother. Each new day contributes 15% to the updated trend while 85% comes from the previous trend. This lets persistent changes move the line while reducing the impact of a single unusually high or low scale reading." },
            { eyebrow: "WEEKLY TREND", title: "The rate comes from three weeks", body: "Weekly Trend is calculated with linear regression across up to the latest 21 days—three full weeks—of smoothed Trend Weight and expressed in pounds per week. Using the full smoothed line makes the estimate more stable than comparing two individual scale readings." },
