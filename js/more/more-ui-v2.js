...
import { initializeBackupManager } from "../core/backup-manager.js?v=backup-complete-4";
import { initializeGoogleDriveSync } from "../core/google-drive-sync-v2.js?v=visible-drive-backup-2";
