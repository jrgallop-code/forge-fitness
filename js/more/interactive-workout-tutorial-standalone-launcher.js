...
function ensureStyles() {
    ...
    style.textContent = `
        ...
        .interactive-workout-standalone-section{display:grid;gap:9px;margin:10px 0 4px;min-width:0}
        ...
        .interactive-workout-standalone-card{box-sizing:border-box;display:grid;grid-template-columns:46px minmax(0,1fr) auto;align-items:center;gap:12px;width:100%;max-width:100%;min-width:0;padding:14px 15px;border:1px solid color-mix(in srgb,var(--accent) 34%,var(--card-border));border-radius:18px;background:linear-gradient(135deg,color-mix(in srgb,var(--accent) 11%,var(--card)),var(--card));color:var(--text);box-shadow:var(--shadow);text-align:left;cursor:pointer;touch-action:manipulation;-webkit-tap-highlight-color:transparent}
        .interactive-workout-standalone-card:active{transform:scale(.995)}
        .interactive-workout-standalone-icon{display:grid;place-items:center;width:46px;height:46px;border-radius:14px;background:var(--accent-soft);font-size:25px;line-height:1}
        .interactive-workout-standalone-copy{display:grid;gap:3px;min-width:0}
        ...
        .interactive-workout-standalone-action{color:var(--accent-text,var(--accent));font-size:10px;font-weight:900;white-space:nowrap}
        @media(max-width:430px){
            .interactive-workout-standalone-card{grid-template-columns:44px minmax(0,1fr);gap:10px;padding:13px}
            .interactive-workout-standalone-icon{width:44px;height:44px}
            .interactive-workout-standalone-action{grid-column:2;justify-self:start;margin-top:2px}
        }
    `;
