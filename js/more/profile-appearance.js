...
export function initializeProfileAppearance({ onBack } = {}) {
    ...
    document.getElementById("profile-appearance-form")?.addEventListener("submit", event => {
        ...
        if (status) status.textContent = "Profile saved. Your anatomy maps are updated.";
    });
}
