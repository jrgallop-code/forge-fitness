...
function resetState(){clearCoachBuildTimer();Object.assign(state,freshState());}
function handleClick(root,event){
  ...
  else if(button.matches("[data-smart-regenerate]")){state.variation+=1;state.generated=generateProgram();showCoachBuild(root);return;}
