...
import { navigate } from "./core/router.js?v=history-rir-edit-1-progress-edge-cards-1-bmi-medical-sources-1";
import { renderNavbar, initializeNavbar } from "./components/navbar.js?v=history-editor-route-1";
import { initializeWorkoutRuntime } from "./workouts/workout-session.js?v=history-rir-edit-1";
...
import { initializeMaintenanceCheckInAlert } from "./nutrition/maintenance-check-in.js?v=calendar-checkin-day-1";
