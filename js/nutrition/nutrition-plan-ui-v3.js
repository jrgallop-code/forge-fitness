    ...
    goalsView.insertAdjacentHTML("beforeend", `
        <div id="active-calorie-target-card" class="goal-box nutrition-goal-card nutrition-current-target-card">
            ...
            <p class="nutrition-message">
                Adjust the inputs first. Level Up then calculates your starting calorie target and shows the active target below.
            </p>
            ...
            <div class="nutrition-manual-settings">
                ...
                <p class="nutrition-message">
                    Leave this on estimated TDEE, or enter your known real-world maintenance calories if you already know them.
                </p>
            ...
            <div class="nutrition-manual-settings">
                ...
                <h3>Fine-Tune Current Calories</h3>
                <p class="nutrition-message">
                    Normally, use the calculated target below. If real-world progress tells you a different intake works better, override the active daily target here.
                </p>
                <label for="manual-calorie-target">Current Daily Calories</label>
                <input id="manual-calorie-target" type="number" min="1" step="10" placeholder="Enter a manual daily target">
                ...
                <div class="nutrition-target-actions">
                    <button id="apply-manual-calories" class="primary-btn" type="button">Apply Manual Target</button>
            ...
            <p class="nutrition-message">
                These values update from the settings above. The Current Daily Target is the number used by the Dashboard, macros, projections and Adaptive Coach.
            </p>
