...
test("builder result assets use fresh production cache keys", async () => {
  ...
  assert.match(html, /smart-build-full-body-guardrails\.js\?v=clean-builder-results-1/);
  assert.match(loader, /smart-build-unified-engine-v11\.js\?v=clean-builder-results-1/);
});
