...
The complete backup must fail rather than silently omit a registered provider that cannot be exported.
...
3. Confirm Export Backup includes the new data.
4. Confirm Import Backup restores the new data.
5. Do not silently create partial backups.
