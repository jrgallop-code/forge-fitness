const CACHE_VERSION = "2026-09-03-194";
...
const CORE_ASSETS = [
    ...
    "./js/core/muscle-map-rendering-fix.js?v=muscle-map-rendering-fix-1",
    ...
    "./js/more/interactive-workout-tutorial-v3.js?v=interactive-workout-tutorial-restored-1",
    ...
    "./js/nutrition/tdee-energy-balance-summary.js?v=energy-balance-summary-1",
