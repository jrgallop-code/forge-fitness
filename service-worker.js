const CACHE_VERSION = "2026-09-13-304";
...
const CORE_ASSETS = [
    ...
    "./js/nutrition/restaurant-menu.js?v=eating-out-6",
    "./css/restaurant-menu.css?v=eating-out-6",
    ...
    "./js/nutrition/tdee-energy-balance-summary.js?v=fatsecret-progress-calories-1",
