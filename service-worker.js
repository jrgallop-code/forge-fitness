const CACHE_VERSION = "2026-09-06-251";
...
const CORE_ASSETS = [
    ...
    "./js/progress/appearance-volume-goals-fix.js?v=appearance-volume-goals-1",
    "./css/appearance-volume-goals-fix.css?v=appearance-volume-goals-1",
