const CACHE_VERSION = "2026-09-24-platform-acquisition-350";
...
const CORE_ASSETS = [
    ...
    "./js/progress/training-analytics-range.js?v=progress-range-first-paint-1",
    ...
    "./css/progress-edge-layout.css?v=progress-edge-cards-1",
    "./css/monthly-report.css?v=pwa-monthly-reports-1",
    ...
    "./js/dashboard/dashboard-goal-timeline.js?v=goal-timeline-2",
    "./css/goal-timeline.css?v=goal-timeline-2",
    ...
    "./js/nutrition/nutrition-mode-ui.js?v=nutrition-mode-ui-1-weekly-informational-checkin-1",
    ...
    "./js/nutrition/weekly-check-in-status.js?v=weekly-checkin-status-1-weekly-informational-checkin-1",
    "./js/nutrition/check-in-calendar.js?v=checkin-calendar-1-weekly-informational-checkin-1",
