const CACHE_VERSION = "2026-09-13-311";
...
const CORE_ASSETS = [
    ...
    "./js/nutrition/tdee-calorie-expenditure-carousel.js?v=energy-balance-range-2",
    "./js/nutrition/energy-balance-state.js?v=energy-balance-range-1",
    "./js/nutrition/tdee-energy-balance-summary.js?v=energy-balance-range-2",
